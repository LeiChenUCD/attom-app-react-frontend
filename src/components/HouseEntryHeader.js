function HouseEntryHeader() {
    return <div style={{minHeight: "30px", border: "1px solid black", display: "flex", flexDirection: "row", fontSize: window.innerWidth > 768 ? "14px" : "13px"}}>
        ...
        <div style={{minWidth: "100px", borderRight: "1px solid black", alignContent: "center", textAlign: "center"}}>Seller Reply</div>
        <div style={{minWidth: "100px", alignContent: "center", textAlign: "center"}}> Due Diligence</div>
    </div>
}
